    ...
    <View style={styles.background}>
      ...
      >
        ...
        <Text style={styles.buttonText}>
          {core.i18n.t("1c76bb73-8f7f-481e-8b76-475117f2b8c7")}
        </Text>
      </TouchableOpacity>
      <TouchableOpacity
        style={styles.button}
        onPress={() => {
          MailComposer.composeAsync({
            ...
            subject: core.i18n.t("d9d63e50-f4af-441d-ab8c-7df1ad8adda7"),
          });
        }}
      >
        <Mail />
        <Text style={styles.buttonText}>
          {core.i18n.t("6f272c11-bad7-4f80-9b99-cb59688942d0")}
        </Text>
      </TouchableOpacity>
      {__DEV__ ? (
        <TouchableOpacity
        ...
        >
          ...
          <Text style={styles.buttonText}>
            {core.i18n.t("ef4acf5c-debd-4fae-a06d-bef7632faae1")}
          </Text>
        </TouchableOpacity>
      ) : null}
      <TouchableOpacity
      ...
      >
        <LogOut />
        <Text style={styles.buttonText}>
          {core.i18n.t("c9bcb9a8-e59c-4ee5-97f1-94dae753a716")}
        </Text>
      </TouchableOpacity>
    </View>
  );
