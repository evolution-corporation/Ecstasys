...
const SubscribeCard: FC<SubscribeCardProps> = (props) => {
  ...
  return (
    <>
      <TouchableOpacity
        style={[styles.background, stylesContent.background, style]}
        onPress={() => onPress()}
      >
        <View style={styles.textPrice}>
          <View style={{ alignItems: "flex-start" }}>
            <Text style={[styles.month, stylesContent.textStyle]}>
              {Tools.i18n.t("d4778887-6b9d-44fc-a20e-c042f82ef115", {
                count: countMonth,
              })}
            </Text>
            {secondElement}
          ...
          <Text style={[styles.priceSubs, stylesContent.textStyle]}>
            ...
            {textPrice.bottom}
            {isFirstPaymant &&
              Tools.i18n.t("a8ffa396-e17e-4836-817a-f4f61bad261d")}
          </Text>
        </View>
        ...
        {!isUsed && (
          <CircleCheck
            ...
            style={styles.checkSelectedSubscribe}
            colorItem={mainColor}
          />
        )}
      </TouchableOpacity>
      {isShowCancelButton && isUsed && (
        <TextButton style={styles.cancelSubs}>
          {Tools.i18n.t("c0c032e5-8965-4703-bed6-77f919acd4d5")}
        </TextButton>
      )}
    </>
  );
