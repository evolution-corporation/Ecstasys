...
export const SMSCodeInput = forwardRef<SMSCodeInputRef, SMSCodeInputProps>(
  (props, ref) => {
    const {
      autoFocus = false,
      onChange,
        ...
        return (
          <Pressable onPress={onPress} style={style}>
            <Text style={styles.timerText}>
              {Tools.i18n.t("2f46f68f-1684-45e3-8e90-391b25bcbcba")}
            </Text>
          </Pressable>
        );
      } else {
        return (
          <View style={[styles.timerBackground, style]}>
            <Text style={styles.textPlaceHolder}>
              {Tools.i18n.t("70baccaa-b4de-4f71-8221-f5f16200887f")}
            </Text>
