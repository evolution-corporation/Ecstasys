...
const MeditationPracticeList: RootScreenProps<"MeditationPracticeList"> = ({ route, navigation }) => {
	...
	const { IsLoading, ListMeditation } = useMeditationListForType(typeMeditation);
	...
	return (
		<DoubleColorView style={styles.background} heightViewPart={height / 2 - 100}>
			...
			<Text style={styles.descriptionType}>
				{Tools.i18n.t(DescriptionMeditationCategory[route.params.typeMeditation].text)}
			</Text>
			{!IsLoading && (
				<CarouselMeditation
					data={ListMeditation}
