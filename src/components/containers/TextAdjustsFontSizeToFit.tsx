...
import { StyleSheet, Text, TextProps, TextStyle, TextLayoutLine } from "react-native";
		...
		return (
			<>
				<Text
					...
					style={[style, { position: "absolute", opacity: 0, width: "100%", height: "100%" }]}
				/>
				{size && (
					<Text
						{...props}
						style={[style, { fontSize: _fontSize, width: "auto", height: "auto" }]}
