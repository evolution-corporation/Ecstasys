	...
	return (
		<Screen backgroundColor={"#9765A8"} paddingHorizontalOff>
			<ScrollView style={{ backgroundColor: "#FFFFFF", paddingHorizontal: 20 }} showsVerticalScrollIndicator={false}>
				<InstructionPattern
					data={[
						{ text: "Процесс начинается с настройки, для этого <b>выбери заинтересовавший тебя сюжет.</b>" },
						{
							text: "Далее <b>выбери музыкальную сессию.</b> Сессии очень разные, в каждой особое настроение и сюжет, который будет вести тебя на протяжении процесса. Ты можешь предварительно прослушать сет, чтобы почувствовать общее настроение сессии.",
						},
						{
							text: "<b>Установи таймер активного дыхания</b> (подробнее ниже) от 5 до 10 минут. Чем дольше время активного дыхания, тем глубже пройдет процесс.",
						},
						{ text: "<b>Установи таймер спонтанного дыхания (подробнее ниже).</b>" },
						{ text: "<b>Начни ДМД</b>" },
					]}
					description={
						"<b>ДМД (Дыхание Музыка Движение)</b> – дыхательный процесс, состоящий из нескольких стадий. Задача ДМД – активировать внутренние ресурсы для раскрытия твоего потенциала, осмыслить происходящее с тобой относительно других граней, найти возможность для новых идей и действий."
					}
				...
				{isShowFeatures ? (
					<Animated.View entering={FadeIn} exiting={FadeOut}>
						<InstructionPattern
							data={[
								{
									text: "Настройка. Задача настройки – <b>погрузить тебя в просоночное состояние</b> или состояние максимального расслабления. Для этого <b>ляг в позу</b>, в которой ты засыпаешь и <b>слушай сюжет. Следуй за сюжетом и визуализируй его</b> или просто слушай, словно сказку перед сном. После того как я предложу тебе «сделать первый мягкий вдох и мягкий медленный выдох», <b>начни медленно и плавно углублять дыхание и постепенно увеличивать его скорость.",
								},
								{
