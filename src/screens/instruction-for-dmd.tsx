			...
			<ScrollView style={{ backgroundColor: "#FFFFFF", paddingHorizontal: 20 }} showsVerticalScrollIndicator={false}>
				<InstructionPattern
					data={[
						...
						{
							text: "Далее выбери музыкальную сессию. Сессии очень разные, в каждой особое настроение и сюжет, который будет вести тебя на протяжении процесса. Ты можешь предварительно прослушать сет, чтобы почувствовать общее настроение сессии.",
						},
						{
					...
					description={
						"ДМД (Дыхание Музыка Движение) – дыхательный процесс, состоящий из нескольких стадий. Задача ДМД – активировать внутренние ресурсы для раскрытия твоего потенциала, осмыслить происходящее с тобой относительно других граней, найти возможность для новых идей и действий."
					}
