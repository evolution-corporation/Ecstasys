...
export async function checkServerAccess(forceCheckConnect: boolean = true): Promise<boolean> {
...
export async function jsonRequest(url: string, parameters: string | null = null, method: RequestMethod = 'GET', body?: string) {
